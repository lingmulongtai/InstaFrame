...
const I18N = {
  en: {
    ...
    mapOverlayTooltip: 'Draws a mini map on the photo area. Requires saved location coordinates and a valid Mapbox token.',
    ...
    mapboxTokenLabel: 'Mapbox Token',
    mapboxTokenHint: 'Your token is used for map overlays instead of the default.',
  ...
  ja: {
    ...
    mapOverlayTooltip: '写真エリアにミニマップを重ねます。保存済みの位置座標と有効なMapboxトークンが必要です。',
    ...
    blurBrightness: '明るさ',
    mapboxTokenLabel: 'Mapboxトークン',
    mapboxTokenHint: 'カスタムトークンはデフォルトより優先して使用されます。',
    showLocation: '位置情報',
